...
example_files=(
    "examples/README.md"
    "examples/01-list-management-examples.md"
    "examples/02-task-management-examples.md"
    "examples/03-search-display-examples.md"
    "examples/04-advanced-features-examples.md"
    "examples/05-configuration-examples.md"
)
