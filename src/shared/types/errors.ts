...
export class ActionPlanValidationError extends BaseError {
  constructor(
    ...
    super(message, 'ACTION_PLAN_VALIDATION_ERROR', true, {
      validationErrors,
      ...context,
    });
  }
...
export class ProjectMigrationError extends BaseError {
  constructor(
    ...
    super(message, 'PROJECT_MIGRATION_ERROR', true, {
      fromVersion,
      toVersion,
      ...context,
    });
...
export class NoteValidationError extends BaseError {
  constructor(
    ...
    super(message, 'NOTE_VALIDATION_ERROR', true, {
      noteId,
      validationErrors,
      ...context,
    });
...
export class NoteNotFoundError extends BaseError {
  constructor(noteId: string, context?: Record<string, unknown>) {
    super(`Note not found: ${noteId}`, 'NOTE_NOT_FOUND', false, {
      noteId,
      ...context,
    });
  }
...
export class FormatValidationError extends BaseError {
  constructor(
    ...
    super(message, 'FORMAT_VALIDATION_ERROR', true, {
      formatOptions,
      ...context,
    });
  }
...
export class CleanupValidationError extends BaseError {
  constructor(
    ...
    super(message, 'CLEANUP_VALIDATION_ERROR', true, {
      itemId,
      reason,
      ...context,
    });
...
export class CleanupOperationError extends BaseError {
  constructor(
    ...
    super(message, 'CLEANUP_OPERATION_ERROR', true, {
      operation,
      itemsAffected,
      ...context,
    });
...
export class DataMigrationError extends BaseError {
  constructor(
    ...
    super(message, 'DATA_MIGRATION_ERROR', true, {
      fromVersion,
      toVersion,
      ...context,
    });
...
export class BackwardCompatibilityError extends BaseError {
  constructor(
    ...
    super(message, 'BACKWARD_COMPATIBILITY_ERROR', false, {
      requiredVersion,
      currentVersion,
      ...context,
    });
...
export class FileNotFoundError extends BaseError {
  constructor(filePath: string, context?: Record<string, unknown>) {
    super(`File not found: ${filePath}`, 'FILE_NOT_FOUND', false, {
      filePath,
      ...context,
    });
  }
...
export class DiskSpaceError extends BaseError {
  constructor(
    ...
    super(message, 'DISK_SPACE_ERROR', false, {
      requiredSpace,
      availableSpace,
      ...context,
    });
...
export class DependencyValidationError extends BaseError {
  constructor(
    ...
    super(message, 'DEPENDENCY_VALIDATION_ERROR', false, {
      taskId,
      dependencyIds,
      ...context,
    });
...
export class InvalidDependencyError extends BaseError {
  constructor(invalidIds: string[], context?: Record<string, unknown>) {
    super(
      `Invalid dependency IDs: ${invalidIds.join(', ')}`,
...
export class InvalidOperationError extends BaseError {
  constructor(
    ...
    super(message, 'INVALID_OPERATION', false, {
      operation,
      reason,
      ...context,
    });
...
export class ResourceConflictError extends BaseError {
  constructor(
    ...
    super(message, 'RESOURCE_CONFLICT', false, {
      resourceId,
      conflictType,
      ...context,
    });
...
export class ResourceExhaustionError extends BaseError {
  constructor(
    ...
    super(message, 'RESOURCE_EXHAUSTION', true, {
      resource,
      limit,
      ...context,
    });
...
export class InvalidConfigurationError extends BaseError {
  constructor(
    ...
    super(message, 'INVALID_CONFIGURATION', false, {
      configKey,
      value,
      ...context,
    });
...
export function isActionPlanError(
  error: Error
): error is ActionPlanParseError | ActionPlanValidationError | ActionStepError {
  return (
    error instanceof ActionPlanParseError ||
    error instanceof ActionPlanValidationError ||
    error instanceof ActionStepError
  );
}

export function isProjectManagementError(
  error: Error
): error is ProjectManagementError | ProjectTagError | ProjectMigrationError {
  return (
...
export function isNotesError(
  error: Error
): error is NotesError | NoteValidationError | NoteNotFoundError {
  return (
...
export function isPrettyPrintError(
  error: Error
): error is PrettyPrintError | FormatValidationError | RenderingError {
  return (
    error instanceof PrettyPrintError ||
    error instanceof FormatValidationError ||
    error instanceof RenderingError
  );
}

export function isCleanupError(
  error: Error
): error is CleanupError | CleanupValidationError | CleanupOperationError {
  return (
...
export function isMigrationError(
  error: Error
): error is MigrationError | DataMigrationError | BackwardCompatibilityError {
  return (
...
export function isNetworkError(
  error: Error
): error is NetworkError | TimeoutError | ConnectionError {
  return (
...
export function isValidationError(
  error: Error
): error is ValidationError | SchemaValidationError {
  return (
    error instanceof ValidationError || error instanceof SchemaValidationError
  );
}

export function isDependencyValidationError(
  error: Error
): error is
  ...
  | SelfDependencyError {
  return (
    error instanceof DependencyValidationError ||
...
export function isSystemError(
  error: Error
): error is SystemError | MemoryError | ResourceExhaustionError {
  return (
...
export function isNotesManagementError(
  error: Error
): error is NotesError | NoteValidationError | NoteNotFoundError {
