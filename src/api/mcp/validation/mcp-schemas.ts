...
export const listAllListsSchema = z.object({
  projectTag: z.string().max(250).optional(),
...
export const updateListMetadataSchema = z.object({
  listId: uuidSchema,
...
export const removeTaskTagsSchema = z.object({
  listId: uuidSchema,
  taskId: uuidSchema,
  tags: z.array(tagSchema).min(1).max(10),
});
...
export const showTasksSchema = z.object({
  listId: uuidSchema,
...
export const setTaskDependenciesSchema = z.object({
  listId: uuidSchema,
  taskId: uuidSchema,
  dependencyIds: z.array(uuidSchema).max(50).optional(),
});

export const getReadyTasksSchema = z.object({
  listId: uuidSchema,
  limit: z.number().int().min(1).max(50).default(20).optional(),
});

export const analyzeTaskDependenciesSchema = z.object({
  listId: uuidSchema,
...
export const setTaskExitCriteriaSchema = z.object({
  listId: uuidSchema,
  taskId: uuidSchema,
  exitCriteria: z.array(z.string().max(500)).max(20).optional(),
});

export const updateExitCriteriaSchema = z.object({
  listId: uuidSchema,
  taskId: uuidSchema,
...
export const MCP_TOOL_SCHEMAS = {
  mcp_tasks_create_list: createListSchema,
  mcp_tasks_get_list: getListSchema,
  mcp_tasks_list_all_lists: listAllListsSchema,
  mcp_tasks_delete_list: deleteListSchema,
  mcp_tasks_update_list_metadata: updateListMetadataSchema,
  mcp_tasks_add_task: addTaskSchema,
  mcp_tasks_update_task: updateTaskSchema,
  mcp_tasks_complete_task: completeTaskSchema,
  mcp_tasks_remove_task: removeTaskSchema,
  mcp_tasks_set_task_priority: setTaskPrioritySchema,
  mcp_tasks_add_task_tags: addTaskTagsSchema,
  mcp_tasks_remove_task_tags: removeTaskTagsSchema,
  mcp_tasks_set_task_status: setTaskStatusSchema,
  mcp_tasks_search_tool: searchToolSchema,
  mcp_tasks_show_tasks: showTasksSchema,
  mcp_tasks_set_task_dependencies: setTaskDependenciesSchema,
  mcp_tasks_get_ready_tasks: getReadyTasksSchema,
  mcp_tasks_analyze_task_dependencies: analyzeTaskDependenciesSchema,
  mcp_tasks_set_task_exit_criteria: setTaskExitCriteriaSchema,
  mcp_tasks_update_exit_criteria: updateExitCriteriaSchema,
  mcp_tasks_get_agent_prompt: getAgentPromptSchema,
} as const;
