  ...
  // Task Management Tools (6 tools)
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        priority: {
          type: 'number',
          description: 'Task priority as a number: 25 (highest) to 1 (lowest), e.g., 25 for urgent tasks',
          minimum: 1,
          maximum: 25,
          default: 3,
        },
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        priority: {
          type: 'number',
          description: 'New priority as a number: 25 (highest/urgent) to 1 (lowest), e.g., 25 for critical tasks',
          minimum: 1,
          maximum: 25,
        },
      },
...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        priority: {
          type: 'number',
          description: 'Filter by priority level (provide as number: 25 for highest priority tasks, 1 for lowest)',
          minimum: 1,
          maximum: 25,
        },
        tag: {
