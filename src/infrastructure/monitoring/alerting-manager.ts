...
import type { ErrorReport } from '../../shared/errors/error-manager.js';
...
export class AlertingManager extends EventEmitter {
  ...
  constructor() {
    super();
    // Defer initialization to avoid logging during module import
    // This will be called when the manager is first used
  }
  ...
  private async sendWebhookNotification(
    ...
    // Webhook notifications not implemented - use console logging instead
    logger.info('Webhook notification (not implemented)', {
      channelId: channel.id,
      alertId: alert.id,
      title: alert.title,
      severity: alert.severity,
  ...
  private async sendEmailNotification(
    ...
    // Email notifications not implemented - use console logging instead
  ...
  private async sendSlackNotification(
    ...
    // Slack notifications not implemented - use console logging instead
