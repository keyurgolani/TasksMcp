 ...
 * Adapts DataSourceRouter to work as both StorageBackend and provide DataAccessService methods
 */
...
export class StorageBackendAdapter extends StorageBackend {
  ...
  // Additional methods for DataAccessService compatibility
