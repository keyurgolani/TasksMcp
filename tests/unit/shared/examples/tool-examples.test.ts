...
import {
  ...
  type ToolExamples as _ToolExamples,
  type ParameterExample as _ParameterExample,
  type ToolExample as _ToolExample,
...
describe('Tool Examples Library', () => {
  ...
  describe('Parameter Examples', () => {
    it('should have examples for commonly problematic parameters', () => {
      ...
      const titleParam = createListExamples.parameters.find(
        p => p.name === 'title'
      );
    ...
    it('should include incorrect examples with explanations', () => {
      ...
      const priorityParam = addTaskExamples.parameters.find(
        p => p.name === 'priority'
      );
    ...
    it('should have realistic correct examples', () => {
      ...
      expect(
        (tagsParam!.correct as string[]).every(tag => typeof tag === 'string')
      ).toBe(true);
    });
  });
  ...
  describe('Utility Functions', () => {
    ...
    describe('getProblematicParameterExamples', () => {
      ...
      it('should include tool context in parameter names', () => {
        ...
        if (
          problematicExamples.priority &&
          problematicExamples.priority.length > 0
        ) {
  ...
  describe('Coverage', () => {
    it('should cover all major MCP tool categories', () => {
      ...
      // Advanced features (analyze_task_dependencies exists but doesn't have examples yet)
